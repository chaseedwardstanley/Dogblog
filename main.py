...
class CreatePostForm(FlaskForm):
    title = StringField("New Dog Name", validators=[DataRequired()])
    subtitle = StringField("New Dog Hobbies", validators=[DataRequired()])
    author = StringField("Owner", validators=[DataRequired()])
    img_url = StringField("Dog Image URL", validators=[DataRequired(), URL()])
    body = CKEditorField("About New Dog", validators=[DataRequired()])
    submit = SubmitField("Submit New Dog")
...
def register():
    ...
    if form.validate_on_submit():
        ...
        if User.query.filter_by(email=form.email.data).first():
            flash("This email has already been used, please log in.", 'error')
